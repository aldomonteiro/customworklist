sap.ui.define([
	...
	return Opa5.extend("my.customworklist.CustomWorklist.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["my/customworklist/CustomWorklist/localService/mockserver"], function (mockserver) {
